...
static void print_tag_foreach(const GstTagList *, const gchar *, gpointer);

/* Print information regarding a stream */
static void print_stream_info(GstDiscovererStreamInfo *info, gint);

/* Print information regarding a stream and its substreams, if any */
static void print_topology(GstDiscovererStreamInfo *, gint);
...
static void on_finished_cb(GstDiscoverer *, CustomData *);
